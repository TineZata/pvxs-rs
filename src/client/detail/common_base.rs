...
use std::sync::Arc;
use crate::{bin::LoadLib, std_types::{StdSharedPtr, StdString}, storetype::StoreType, value::Value};
...
pub struct CommonBase {
    ...
    pub req: StdSharedPtr,
    pub _prio: ::std::os::raw::c_uint,
    pub _autoexec: bool,
...
impl CommonBase {
    ...
    pub unsafe fn _field(&mut self, s: *const StdString, pvxs_library: Arc<LoadLib>) {
    ...
    pub unsafe fn _parse(&mut self, req: *const StdString, pvxs_library: Arc<LoadLib>) {
        pvxs_client_detail_common_base_parse(self, req, pvxs_library)
    }
    
    pub unsafe fn _build_req(&self, pvxs_library: Arc<LoadLib>) -> Value {
...
pub unsafe fn pvxs_client_detail_common_base_raw_request(this: *mut CommonBase, arg1: *const Value, pvxs_library: Arc<LoadLib>)
{
...
pub unsafe  fn pvxs_client_detail_common_base_field(this: *mut CommonBase,s: *const StdString, pvxs_library: Arc<LoadLib>)
{
    let func: Symbol<unsafe extern "C" fn(*mut CommonBase, *const StdString) -> *const std::os::raw::c_char> = 
    pvxs_library.lib
    .get(if cfg!(target_os = "windows") {
...
pub unsafe fn pvxs_client_detail_common_base_record(this: *mut CommonBase, key: *const StdString, 
    value: *const ::std::os::raw::c_void, vtype: StoreType, pvxs_library: Arc<LoadLib>)
{
    let func: Symbol<unsafe extern "C" fn(*mut CommonBase, *const StdString, *const ::std::os::raw::c_void, StoreType) -> *const std::os::raw::c_char> = 
    pvxs_library.lib
    .get(if cfg!(target_os = "windows") {
...
pub unsafe fn pvxs_client_detail_common_base_parse(this: *mut CommonBase, req: *const StdString, pvxs_library: Arc<LoadLib>)
{
    let func: Symbol<unsafe extern "C" fn(*mut CommonBase, *const StdString) -> *const std::os::raw::c_char> = 
    pvxs_library.lib
    .get(if cfg!(target_os = "windows") {
...
pub unsafe fn pvxs_client_detail_common_base_build_req(this: *const CommonBase, pvxs_library: Arc<LoadLib>) -> Value
{
...
pub unsafe fn pvxs_client_detail_common_base_common_base_destructor(this: *mut CommonBase, pvxs_library: Arc<LoadLib>)
{
